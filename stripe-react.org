...
*** Stripe Developers Section
    ...
    [[file:./img/stripe-payments-integration-dashboard-50.png]]
...
** Steps for Creating a Webshop
  ...
  *WARNING:* You should never send raw credit card details to your
  ...
  [[file:img/stripe-payments-dashboard-api-key-50.png]]
...
*** POST Request to Stripe
    ...
    *Do not forget:. You should never use your swiss army Secret key
    ...
    [[file:img/Stripe-Dashboard-API-Key-Restricted-50.png]]
...
*** Create Products and Assign SKUs
    ...
    [[file:img/stripe-payments-dashboard-banana-product-creation-50.png]]

    #+ATTR_HTML: :width 75%
    #+ATTR_TEXINFO: :width 6in
    #+NAME:fig:create-sku
    #+CAPTION:Create a SKU
    [[file:img/Stripe-Payments-Dashboard-Stock-Keeping-Unit-50.png]]
...
*** Create a Coupon for Testing
    ...
    *Billing* menu on the *Coupons* tab.
    ...
    [[file:img/Stripe-Payments-Dashboard-Coupon-Creation-50.png]]
    ...
    [[file:img/Stripe-Payments-Shop-Orders-50.png]]
...
*** Webhook Setup using Stripe Dashboard
   ...
   *Filter event* select =Select types to send= and search for
   ...
   [[file:img/Stripe-Dashboard-Webhook-Creation-50.png]]
...
#+MACRO: CREATE-DATE Created 2019-02-01 Fri 10:38
